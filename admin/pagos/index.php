                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <!-- {{-- REALIZAR PAGO --}} -->
                                            <a type="button" class="btn btn-success" href="cuotas.php?id=<?= $id_estudiante; ?>">
                                                <i class="fa fa-fw  bi bi-cash-coin"></i>
                                            </a>

                                            <!-- {{-- IMPRIMIR CONTRATO --}} -->
                                            <a type="button" class="btn btn-warning" target="_blank" href="contrato.php?id=<?= $id_estudiante; ?>">
