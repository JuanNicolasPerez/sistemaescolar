            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-outline card-primary" style="background: #d3d2d2">
                        ...
                        <div class="card-body">
                            <form action="<?= APP_URL; ?>/app/controller/materias/createController.php" method="post">
                                <div class="row">                                    
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <center>
                                                ...
                                                <a href="<?= APP_URL; ?>/admin/materias" type="button" class="btn btn-secondary">Cancelar</a>
                                            </center>
                                        </div>
                                    </div>
                                </div>
