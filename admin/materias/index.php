                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <!-- {{-- MOSTRAR --}} -->
                                                    <a type="button" class="btn btn-info" href="show.php?id=<?= $id_materia; ?>">
                                                        <i class="fa fa-fw fa-eye"></i>
                                                    </a>

                                                    <!-- {{-- EDITAR --}} -->
                                                    <a type="button" class="btn btn-success" href="edit.php?id=<?= $id_materia; ?>">
                                                        <i class="fa fa-fw fa-edit"></i>
                                                    </a>

                                                    <!-- {{-- ELIMINAR --}} -->
                                                    <form action="<?= APP_URL; ?>/app/controller/materias/deleteController.php" method="post"
                                                        onclick="preguntar<?= $id_materia; ?>(event)" id="miformulario<?= $id_materia; ?>">
                                ...
                                $(function() {
                                    $("#example1").DataTable({
                                        ...
                                        "language": {
                                            ...
                                            "sInfoFiltered": "(filtrado de _MAX_ total materias)",
                                            "sInfoPostFix": "",
                                            "thousands": ",",
