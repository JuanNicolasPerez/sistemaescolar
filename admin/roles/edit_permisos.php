...
//BUSCAMOS EL ROL EN EL CONTROLLER
include('../../app/controller/roles/datos_permisos_Controller.php');
?>
                ...
                <div class="col-md-6">
                    <div class="card card-outline card-success" style="background: #d3d2d2">
                        <div class="card-header">
                            <h3 class="card-title">Modificar el permiso</h3>
                        ...
                        <div class="card-body">
                            <form action="<?= APP_URL; ?>/app/controller/roles/updatePermisoController.php" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombre_url">Nombre de la URL</label>
                                            <input type="text" name="id_permiso" value="<?= $id_permiso; ?>" class="form-control" hidden>
                                            <input type="text" name="nombre_url" value="<?= $nombre_url; ?>" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
