                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?=APP_URL."/public/images/configuracion/".$institucion['logo']; ?>" alt="Imagen Logo" style="width: 50px;">
                                    </td>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <!-- {{-- MOSTRAR --}} -->
                                            <a type="button" class="btn btn-info" href="show.php?id=<?= $id_config_institucion; ?>">
                                                <i class="fa fa-fw fa-eye"></i>
                                            </a>

                                            <!-- {{-- EDITAR --}} -->
                                            <a type="button" class="btn btn-success" href="edit.php?id=<?= $id_config_institucion; ?>">
                                                <i class="fa fa-fw fa-edit"></i>
                                            </a>

                                            <!-- {{-- ELIMINAR --}} -->
                                            <form action="<?= APP_URL; ?>/app/controller/configuraciones/institucion/deleteController.php" method="post"
                                            onclick="preguntar<?= $id_config_institucion; ?>(event)" id="miformulario<?=$id_config_institucion;?>">
                        ...
                        $(function() {
                            $("#example1").DataTable({
                                ...
                                "language": {
                                    ...
                                    "sInfo": "Mostrando  _START_ a _END_ de _TOTAL_ instituciones",
                                    "sInfoEmpty": "Mostrando 0 a 0 de 0 instituciones",
