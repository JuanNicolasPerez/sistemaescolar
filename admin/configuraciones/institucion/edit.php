                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success" style="background: #d3d2d2">
                        <div class="card-header">
                            <h3 class="card-title">Modifificar los datos institución</h3>
                        ...
                        <div class="card-body">
                            <form action="<?= APP_URL; ?>/app/controller/configuraciones/institucion/updateController.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nombre_institucion" class="form-control" value="<?= $nombre_institucion; ?>" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" value="<?= $correo; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <center>
                                                    <output id="list">
                                                        <img src="<?=APP_URL."/public/images/configuracion/".$logo; ?>" alt="Imagen Logo" style="width: 80%;">
                                                    </output>
                                                </center>
                                                <!-- {{-- CARGAR LA IMAGEN --}} -->
                                                <script>
